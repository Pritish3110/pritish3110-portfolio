...
const JourneyTimeline = ({ shouldAnimate }) => {
  const timelineEvents = [
    ...
    {
      year: 'Jul 2025',
      title: 'Mafkin Robotics — Machine Learning & Robotics Intern',
      description: 'Environment mapping with ZED2i + Jetson Orin (RTAB) — 3D mesh creation.',
      type: 'internship',
    ...
    },
    {
      ...
      description: 'Flood-fill navigation, sensor integration, calibration, embedded control.',
      type: 'project',
