...
import { User, Zap, MessageSquare, FolderOpen, Menu, X, Briefcase, Star, FileText, BadgeCheck} from 'lucide-react';
...
const Navbar = ({ activeSection, onNavigate }) => {
  ...
  const navItems = [
    ...
    { id: 'achievements', label: 'Certifications', icon: <BadgeCheck className="w-4 h-4" /> },
